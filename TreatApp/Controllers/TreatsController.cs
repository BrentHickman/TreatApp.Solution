...
namespace TreatApp.Controllers
{
    ...
    public class TreatsController : Controller
    {
        ...
        public TreatsController(UserManager<ApplicationUser> userManager, TreatAppContext db)
        {
        ...
        public async Task<IActionResult> Index(string sortOrder)
        {
            ...
            switch (sortOrder)
            {
                case "description_desc":
                    treats = userTreats.OrderBy(r => r.Description);
                    break;
                case "price_desc":
                    treats = userTreats.OrderByDescending(r => r.Price);
                    break;
                default:
        ...
        [HttpPost]
        public ActionResult Rate(Treat treat)
        {
            _db.Treats.Update(treat);
            _db.SaveChanges();
            return RedirectToAction("Index");
